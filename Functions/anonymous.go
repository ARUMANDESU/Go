...
func main() {
	...
	*/
	...
	// This function si similar to a regular function - except it does not have a name.
	// Also, in this example, you directly call the function right after the definition.

	send_func := give_me_a_func()
	send_func("Hi, it's not me!")
}
